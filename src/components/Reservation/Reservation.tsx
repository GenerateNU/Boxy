...
export default function Reservation({reservation, header, sub} : any) {
    ...
    const dateRange: [string, string] = reservation.datesRequested.length >= 2 
                                        ? [new Date(reservation.datesRequested[0]).toLocaleString('default', {month: 'long', day: '2-digit'}), new Date(reservation.datesRequested[1]).toLocaleString('default', {month: 'long', day: '2-digit'})]
                                        : ["N/A", "N/A"];
