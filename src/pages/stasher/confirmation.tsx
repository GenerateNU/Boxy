    ...
    <div className="w-[64%] pt-20 items-center text-center mx-auto">
      ...
      <div className="flex flex-row mt-4 px-2 mr-4">
        <div className="flex-grow">
          <div className="text-left mb-2">Details</div>
          <div className="flex flex-col border-2 border-[#B5B5B5] rounded-md mr-8">
        ...
        <div className="flex-grow">
          <div className="text-left mb-2">Storage items</div>
          <div className="flex flex-col border-2 border-[#B5B5B5] rounded-md">
            <div className="flex flex-row mx-4 py-4 text-bold text-3xl border-b-2 border-b-[#B5B5B5]">
              <div>Total</div>
              <div className="flex-grow text-end">$350</div>
            </div>
