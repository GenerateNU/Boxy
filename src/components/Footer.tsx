...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white pt-20 mt-2 border-t border-gray-300">
        ...
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-4">
                008C - Hayden Hall, Northeastern University, Boston MA - 02115
              </p>
              <p className="">Support@storewithboxy.com</p>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="http://localhost:3000#faq-section"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                  >
                    FAQs
                  </a>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color text-base">&copy; 2022 Boxy</p>
            </div>
          </div>
        </div>
      </div>
